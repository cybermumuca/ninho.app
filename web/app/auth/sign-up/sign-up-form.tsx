...
export function SignUpForm() {
  ...
  async function handleGithubSignUp() {
    ...
    try {
      ...
      toast.success("Cadastro com GitHub realizado com sucesso!", {
        description: "Enviaremos um email quando sua conta for aceita!",
        icon: <PartyPopper className="h-5 w-5" />,
        richColors: true,
      })
    } catch (error) {
      toast.error("Erro ao fazer cadastro com GitHub")
    ...
    <div className="flex flex-col gap-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Preencha os dados abaixo para criar sua conta no Ninho
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
